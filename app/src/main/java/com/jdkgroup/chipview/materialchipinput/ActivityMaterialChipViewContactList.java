...
public class ActivityMaterialChipViewContactList extends AppCompatActivity {

    private static final String TAG = ActivityMaterialChipViewContactList.class.toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_chip_view_contact_list);
        // butter knife
        ...
        mChipsInput.addChipsListener(new ChipsInput.ChipsListener() {
            ...
            public void onChipAdded(ChipInterface chip, int newSize) {
                Log.e(TAG, "chip added, " + chip.getLabel());
            }
